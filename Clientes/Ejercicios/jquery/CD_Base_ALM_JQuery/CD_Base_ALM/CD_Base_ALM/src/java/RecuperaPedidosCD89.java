    ...
    PrintWriter out=response.getWriter();
        ...
        // Paso 3: Crear sentencias SQL, utilizando objetos de tipo Statement
            ...
            //JSONObject pedidoJs = new JSONObject(pedido);
              ...
              int cpedido =Integer.parseInt((String)request.getParameter("cpedido"));
              String nif  = (String) request.getParameter("cliente");
            
          //Todos los clientes con pedidos.............
          if (nif.equals("todosPedidos")){
            rs=stmt.executeQuery("select distinct concat(nombre,\", \",apellidos) nombre, nif\n" +
