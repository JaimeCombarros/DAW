...
@WebServlet("/CargaProvMuni") 
public class CargaProvMuni extends HttpServlet {
    ...
    //    try {
            ...
            int idProv =Integer.parseInt(provincia);
            ...
            if(idProv==0)
                {
                    ...
                    id="idprovincia";name="provincia";
                     ...
                     consulta ="Select idpoblacion,poblacion, latitud,longitud from poblacion "
                                + " where idprovincia ='"+idProv+"' order by poblacion";
